	...
	<div class="container">
		<div class="row" style="padding:25px;">
			...
			<div class="col-lg-8 text-center">
				<h3 class="section-heading"><spring:message code="init.page.zone1" /></h3>
			</div>
		</div>
	...
	<div class="row" >
		<div class="col-lg-5 text-left" style="padding-top: 6%;padding-left: 3%;padding-bottom: 3%;" >
			<h4 class="section-heading">
				...
				<p>
					<spring:message code="init.page.zone2.answer1" />
				</p>
			</h4>
		</div>
		...
		<div class="row" >
			...
			<div class="col-lg-5 text-left" style="padding-top: 4%;padding-left: 3%;padding-bottom: 3%;" >
				<h4 class="section-heading">
					...
					<p>
						<spring:message code="init.page.zone3.answer1" />
					</p>
				</h4>
			</div>
	...
	<div class="row" >
		<div class="col-lg-5 text-left" style="padding-top: 2%;padding-left: 3%;padding-bottom: 3%;" >
			<h4 class="section-heading">
				...
				<p>
					<spring:message code="init.page.zone4.answer1" />
				</p>
			</h4>
		</div>
		<div class="col-lg-1 text-center"></div>
...
<section id="contact">
	<div class="container">
		<div class="row" style="padding:25px;">
			<div class="col-lg-2 text-center"></div>
			<div class="col-lg-8 text-center">
				<h3 class="section-heading"><spring:message code="init.page.zone5" /></h3>
				<br/>
				<a href="https://play.google.com/store/apps/details?id=com.inmobile.ojovial" class="btn btn-xl page-scroll" target="_blank">
					<img src="${pageContext.request.contextPath}/resources/bootstrap/img/googleplay.png" class="img-responsive" alt="Cinque Terre">
				</a>
			</div>
		</div>
