insert into tb_system_param (generalParam,nameParam,reasonParam,valueParam,status) values ('EMAIL','EMAIL_FROM_COMPLAINT','Email for send mail specific complaint','albertopaico10@gmail.com',1);
insert into tb_system_param (generalParam,nameParam,reasonParam,valueParam,status) values ('EMAIL','EMAIL_FROM_CREATION_USER','Email for send mail specific creation user','albertopaico10@gmail.com',1);
insert into tb_system_param (generalParam,nameParam,reasonParam,valueParam,status) values ('EMAIL','PASSWORD_FROM','Password for send mail','Pa55w0rd4097',1);
...
insert into tb_system_param (generalParam,nameParam,reasonParam,valueParam,status) values ('EMAIL','EMAIL_SMTP_OJOVIAL','Configuration Value for Send Email OJO VIAL SMTP','smtp.gmail.com',1);
insert into tb_system_param (generalParam,nameParam,reasonParam,valueParam,status) values ('EMAIL','EMAIL_PORT_OJOVIAL','Configuration Value for Send Email OJO VIAL PORT','25',1);
...
insert into tb_system_param (generalParam,nameParam,reasonParam,valueParam,status) values ('EMAIL','EMAIL_FROM_COMPLAINT_GMAIL','Email for send mail specific complaint','albertopaico10@gmail.com',1);
insert into tb_system_param (generalParam,nameParam,reasonParam,valueParam,status) values ('EMAIL','EMAIL_FROM_CREATION_USER_GMAIL','Email for send mail specific creation user - GMAIL','albertopaico10@gmail.com',1);
insert into tb_system_param (generalParam,nameParam,reasonParam,valueParam,status) values ('EMAIL','PASSWORD_FROM_GMAIL','Password for send mail','Pa55w0rd4097',1);
