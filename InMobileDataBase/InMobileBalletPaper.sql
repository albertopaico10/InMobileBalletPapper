...
select * from tb_province where departmentId=15;
select * from tb_district where provinceId=127;


insert into tb_country values(1,'Peru','PE');
commit;
...
insert into tb_district values 
(1, 'CHACHAPOYAS', 1),
(2, 'ASUNCION', 1),
(3, 'BALSAS', 1),
(4, 'CHETO', 1),
